...
(1, '¿Te gustó?', 'checkbox', 'NULL', 1, 1, 0),
(2, '¿Lo completaste?', 'checkbox', NULL, 1, 1, 0),
(3, '¿Lo recomendas?', 'checkbox', NULL, 1, 1, 0),
(4, '¿Tuviste problemas para jugarlo?', 'checkbox', '', 1, 1, 0),
(5, '¿Cuantas horas jugaste?', 'option', '1|5|10|más', 1, 1, 0),
...
(2, 'The Evil Within 2', 'De la mente maestra Shinji Mikami, The Evil Within 2 es la última evolución del horror de supervivencia. El detective Sebastian Castellanos lo ha perdido todo, incluida su hija, Lily. Para salvarla, debe descender al mundo de pesadilla de STEM. Amenazas horribles surgen de cada esquina, y debe confiar en su ingenio para sobrevivir. Para su única oportunidad de redención, la única salida es entrar una vez más al mundo de pesadilla de STEM. Horribles amenazas surgen de cada esquina a medida que el mundo gira y se deforma a su alrededor. Se enfrentará Sebastián a la adversidad de frente con armas y trampas, o se escabullirá entre las sombras para sobrevivir?', 0, 5025.99, 0, 30, 'Tango Gameworks', '2017-10-13', 1, 1, 5, 1),
(3, 'Mortal Kombat 11', 'Mortal Kombat 11, la más reciente entrega de la aclamada franquicia, te ofrece una experiencia más profunda y personalizada que nunca. Con las nuevas variantes de personaje tendrás un control sin precedentes para personalizar a tus Luchadores y hacerlos únicos. Mortal Kombat 11 incluye el juego principal y los personajes complementarios jugables: Shang Tsung, Nightwolf, Terminator T-800, Sindel, el Guasón y Spawn.', 0, 8199.99, 0, 52, 'NetherRealm Studios', '2019-04-23', 1, 5, 5, 1),
